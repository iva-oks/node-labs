				...
				<div className="profileContainer">
					<div className="uInfo">
						...
						<div className="center">
							<span>{data.name}</span>
							{rIsLoading ? "loading" : userId === currentUser._id ? (<button  onClick={() => setOpenUpdate(true)}>Оновити профіль</button>) : <button onClick={handleFollow}>{relationshipData.includes(currentUser._id) ? "Відписатись" : "Підписатись"}</button>}
						</div>
						<div className="right">
